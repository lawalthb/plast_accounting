        ...
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-auto  " >
                    <a  class="btn btn-primary" href="<?php print_link("marketers/marketer_add", true) ?>" >
        ...
        <div class="row ">
            <div class="col-md-12 comp-grid " >
                ...
                <div  class=" page-content" >
                    <div id="marketers-marketers_list-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/marketers/marketers_list", $field_name, $field_value); ?>
                            <table class="table table-hover table-striped table-sm text-left">
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <!--PageComponentEnd-->
                                        <td class="td-btn">
                                            <a class="btn btn-sm btn-success has-tooltip "    href="<?php print_link("marketers/edit/$rec_id"); ?>" >
