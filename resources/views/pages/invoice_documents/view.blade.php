...
<?php
    $pageTitle = __('invoiceDocumentsDetails'); //set dynamic page title
?>
@extends($layout)
...
<section class="page" data-page-type="view" data-page-url="{{ url()->full() }}">
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid " >
                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            <div class="row gutter-lg ">
                                        ...
                                        <div class="mb-3 row row gutter-lg">
                                            ...
                                            <div class=" col-12 col-md-4">
                                                <div class="bg-light mb-3 card-1 p-2 border rounded">
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <small class="text-muted">{{ __('docDate') }}</small>
                                                            <div class="fw-bold">
                                            ...
                                            <div class=" col-12 col-md-4">
                                                <div class="bg-light mb-3 card-1 p-2 border rounded">
                                                    <div class="row align-items-center">
                                                        <div class="col">
                                                            <small class="text-muted">{{ __('docType') }}</small>
                                                            <div class="fw-bold">
                                                                ...
                                                                <i class="material-icons">visibility</i> <?php echo "Source Documents Detail" ?>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class=" col-12 col-md-4">
                                    <div class="bg-light mb-3 card-1 p-2 border rounded">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <small class="text-muted">{{ __('customerLegderId') }}</small>
                                                <div class="fw-bold">
                            ...
                            <div class=" col-12 col-md-4">
                                <div class="bg-light mb-3 card-1 p-2 border rounded">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <small class="text-muted">{{ __('salesLedgerId') }}</small>
                                            <div class="fw-bold">
                    ...
                    <div class="d-flex gap-1 justify-content-start">
                        <a class="btn btn-sm btn-success has-tooltip "   title="{{ __('edit') }}" href="<?php print_link("invoice_documents/edit/$rec_id"); ?>" >
                        <i class="material-icons">edit</i> {{ __('edit') }}
                    </a>
                    <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" title="{{ __('delete') }}" href="<?php print_link("invoice_documents/delete/$rec_id?redirect=invoice_documents"); ?>" >
    ...
    <div class="col-12">
        <div class="my-3 ">
            @include("pages.invoice_documents.detail-pages", ["masterRecordId" => $rec_id])
        </div>
    </div>
    <?php } ?>
</div>
