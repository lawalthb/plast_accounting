            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="ledgers-suppliers_add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('ledgers.suppliers_add_store') }}" method="post">
                            @csrf
                            <div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <small class="form-text">choose sundry creditors if available</small>
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <small class="form-text">Amount company is owning supplier</small>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <small class="form-text">Amount customer is owning supplier</small>
                                    </div>
                                </div>
                            </div>
