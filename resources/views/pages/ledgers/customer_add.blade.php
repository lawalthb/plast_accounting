            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="ledgers-customer_add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-vertical needs-validation" action="{{ route('ledgers.customer_add_store') }}" method="post">
                            @csrf
                            <div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div id="ctrl-sub_account_group_id-holder" class=" "> 
                                            <select required=""  id="ctrl-sub_account_group_id" data-field="sub_account_group_id" name="sub_account_group_id"  placeholder="{{ __('selectAGroup') }}"    class="form-select" >
                                            <option value="">{{ __('selectAGroup') }}</option>
                                            <?php 
                                        ...
                                        <small class="form-text">choose sundry debtors if available</small>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label class="control-label" for="ledger_name">{{ __('customerName') }} <span class="text-danger">*</span></label>
                                        <div id="ctrl-ledger_name-holder" class=" "> 
                                            <input id="ctrl-ledger_name" data-field="ledger_name"  value="<?php echo get_value('ledger_name') ?>" type="text" placeholder="{{ __('enterCustomerName') }}"  required="" name="ledger_name"  class="form-control " />
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
