            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("options/user_edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-option_name-holder" class=" ">
                                            <input id="ctrl-option_name" data-field="option_name"  value="<?php  echo $data['option_name']; ?>" type="text" placeholder="{{ __('enterOptionName') }}"  readonly required="" name="option_name"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
