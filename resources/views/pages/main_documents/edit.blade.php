...
<?php
    $pageTitle = __('editMainDocuments'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("main_documents/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-affect_account-holder" class=" ">
                                            ...
                                            <?php
                                                ...
                                                $selected = ( $value == $data['affect_account'] ? 'selected' : null );
                                            ?>
