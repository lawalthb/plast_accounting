...
<?php
    ...
    $pageTitle = __('mainDocuments'); //set dynamic page title
?>
@extends($layout)
        ...
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-auto  " >
                    <a  class="btn btn-primary" href="<?php print_link("main_documents/add", true) ?>" >
        ...
        <div class="row ">
            <div class="col-md-12 comp-grid " >
                ...
                <div  class=" page-content" >
                    <div id="main_documents-list-records">
                                        ...
                                        <tbody class="page-data">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-masterdetailbtn">
                                                    <a data-page-id="main_documents-detail-page" class="btn btn-sm btn-secondary open-master-detail-page" href="<?php print_link("main_documents/masterdetail/$data[id]"); ?>">
                                                    <i class="material-icons">more_vert</i> 
                                                </a>
                                            </td>
                                            <td class="td-id">
                                                <a href="<?php print_link("main_documents/view/$data[id]") ?>"><?php echo $data['id']; ?></a>
                                            </td>
                                            <td class="td-name">
                                                <?php echo  $data['name'] ; ?>
                                            </td>
