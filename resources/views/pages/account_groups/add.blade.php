...
<?php
    $pageTitle = __('addNewAccountGroups'); //set dynamic page title
?>
@extends($layout)
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    ...
                    <div  class="card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="account_groups-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('account_groups.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-code-holder" class=" ">
                                                <input id="ctrl-code" data-field="code"  value="<?php echo get_value('code') ?>" type="text" placeholder="{{ __('enterCode') }}"  required="" name="code"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
