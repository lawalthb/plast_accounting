                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-particular" > {{ __('particular') }}</th>
                                        <th class="td-reg_date" > {{ __('regDate') }}</th>
                                        <th class="td-stock_in" > {{ __('stockIn') }}</th>
                                        <th class="td-stock_out" > {{ __('stockOut') }}</th>
                                        <th class="td-stock_balance" > {{ __('stockBalance') }}</th>
                                        <th class="td-doc_no" > {{ __('docNo') }}</th>
                                        <th class="td-user_id" > {{ __('userId') }}</th>
                                        <th class="td-company_id" > {{ __('companyId') }}</th>
                                        <th class="td-amount_in" > {{ __('amountIn') }}</th>
                                        <th class="td-amount_out" > {{ __('amountOut') }}</th>
                                        <th class="td-ledger_id" > {{ __('ledgerId') }}</th>
                                        <th class="td-btn"></th>
                                    </tr>
                                </thead>
                                <?php
